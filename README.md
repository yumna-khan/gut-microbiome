...
Overall, this study aims to characterize and compare the gut microbiome composition of Italian omnivores and vegans in order to investigate how dietary patterns shape microbial diversity and species-level abundance.
...
Alpha diversity analysis ([Figure 2](figures/alpha.png)) showed higher median observed species richness in omnivores (median = 134) compared to vegans (median = 118), alongside greater variability in both observed richness and Shannon index values, although neither difference was statistically significant. The higher richness in omnivores is consistent with Fackelmann et al. (2025), who reported lower observed species richness in vegans across multiple cohorts, and may reflect the broader range of dietary substrates in omnivorous diets supporting more heterogeneous microbial communities, whereas vegan diets may promote more specialised fibre-degrading taxa. Shannon index values were similar between groups (omnivores: median = 3.05; vegans: median = 3.03), suggesting that while omnivores harbour more species overall, community evenness is comparable between dietary groups. The greater variance in Shannon diversity among omnivores further suggests increased inter-individual variability in community structure, potentially reflecting wider variation in food choices within an omnivorous diet compared to the more restricted vegan diet.

Beta diversity analysis ([Figure 3](figures/beta.png)) further suggested a diet-associated effect. PCoA of Bray-Curtis dissimilarity showed partial separation between dietary groups, with omnivore samples clustering in the upper portion and vegan samples in the lower portion of the plot along PC2, which explained 23.6% of the total variation, while PC1 explained 48.3%. Diet explained 25% of the variation in community composition (PERMANOVA R² = 0.25, p = 0.4), which was not statistically significant. This partial separation is consistent with Filippis et al. (2019), whose PCoA of the same Italian omnivore and vegan cohort showed clear clustering of omnivores and vegans/vegetarians along PC1, which explained 26.4% of variation, demonstrating that dietary pattern drives measurable differences in gut microbiome composition in this population. The non-significant PERMANOVA result in this study likely reflects limited statistical power with only 3 samples per group rather than a true absence of a dietary effect, as the visual separation in the PCoA and the R² of 0.25 suggest a biologically meaningful trend consistent with the full cohort findings.

### Differential Abundance
Differential abundance analysis ([Figure 4](figures/da.png)) identified no statistically significant species after Benjamini-Hochberg correction; however, several biologically relevant trends were observed. _Sutterella wadsworthensis_ showed the highest log fold change in vegans. Although its role remains poorly understood, it is commonly detected in healthy individuals but has also been linked to metabolic and inflammatory conditions through IgA degradation and potential facilitation of pathobiont invasion (Hiippala et al., 2016; Kaakoush, 2020). Its higher abundance in vegan samples may reflect the selective enrichment of certain Proteobacteria under fibre-rich dietary conditions, though this requires further investigation. 

Conversely, _Coprococcus eutactus_, a butyrate-producing species important for gut barrier integrity and anti-inflammatory activity (Notting et al., 2023), was more abundant in omnivores alongside _Alistipes onderdonkii_ and _[Ruminococcus] lactaris_. The higher abundance of _C. eutactus_ in omnivores is somewhat unexpected given the higher fibre intake typical of vegan diets, which would be expected to promote butyrate-producing species, and may reflect individual variation rather than a consistent dietary effect.

Notably, several other butyrate-producing species including _Butyrivibrio crossotus_, _Ruminococcus bicirculans_, and _Intestinimonas butyriciproducens_ showed higher log fold changes in vegans. Fermentable dietary fibre serves as a primary substrate for intestinal bacteria producing SCFAs including butyrate, which plays a key role in immunoregulation, maintenance of epithelial barrier function, and prevention of inflammatory conditions (Sakkas et al., 2020). This is consistent with Fackelmann et al. (2025), who found enrichment of fibre-degrading Lachnospiraceae and butyrate-producing species in vegan gut microbiomes, suggesting that the overall directional trend toward SCFA-producing taxa in vegans observed here reflects a genuine biological signal that larger studies with adequate statistical power would likely confirm.


### Limitations
The primary limitation of this study is the small sample size (n = 3 per group), which severely limited statistical power across all analyses and constrained the number of permutations achievable in PERMANOVA. Additionally, the use of a reduced Kraken2 standard 8GB database, rather than the full database, may have limited taxonomic resolution and resulted in some taxa being missed or misclassified. The analysis was also restricted to species-level classification, which does not capture strain-level variation that may be critical for taxa such as _S. copri_, known to exhibit functionally distinct strains. Furthermore, potential confounding factors such as host genetics, lifestyle, and prior antibiotic use were not accounted for, which may contribute to the observed inter-individual variability. Future studies with larger cohorts, more comprehensive reference databases, and strain-level analyses are needed to better resolve diet-associated microbial patterns and clarify the role of key taxa.
